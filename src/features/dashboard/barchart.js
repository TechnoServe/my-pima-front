      ...
      <div>
        <ResponsiveContainer width='100%' height={200}>
          <BarChart data={data} margin={{ top: 30, right: 30, left: 0, bottom: 5 }}>
            <CartesianGrid vertical={false} stroke='rgba(28, 28, 28, 0.1)' strokeWidth={1} />
            <XAxis
              dataKey='name'
              ...
              tickMargin={12}
            />
            <YAxis axisLine={false} tick={{ fontSize: 12, fill: '#1c1c1c66' }} tickLine={false} />
            <Tooltip
              contentStyle={{
                fontSize: 12,
            ...
            />
            <Bar dataKey='value' fill='rgba(37, 36, 93, 1)' radius={[5, 5, 0, 0]} barSize={30} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
