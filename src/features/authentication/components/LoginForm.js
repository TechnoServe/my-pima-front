        ...
        <div className='form__starts'>
          ...
          <form>
            ...
            <div className='form-footer'>
              <div>
                <input type='checkbox' name='remember' id='remember' className='form__checkbox box' />
            ...
            <div className='form__auth'>
              <button type='submit' className='form__btn' onClick={handleLogin} disabled={loading}>
                {loading ? <BeatLoader color='#fff' loading={true} size={10} /> : 'Login'}
              </button>
            </div>
