...
const Participants = ({ participants, trainingGroups, selectedProject, projects }) => {
  ...
  return (
    <div>
      ...
      <UploadParticipantsModal
        open={open}
        setOpen={setOpen}
        navigatedProject={projects.find((project) => project.sf_project_id === selectedProject).project_name}
      />
    </div>
  )
}
