...
const LoadingPage = ({ loadings }) => {
  ...
  const gradientColors = ['#1F2272', '#1C1E62', '#3A3D89', '#4998CC', '#4B8C68', '#0E0E0E', '#18472D', '#023938', '#404948', '#7A8786']
  ...
  const gradientColor = gradientColors[Math.min(Math.floor(percentage / 10), 9)]
